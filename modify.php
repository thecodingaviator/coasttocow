...
if (isset($_POST['submit'])) {
  ...
  if ($result == $old_password) {
    $sql = "UPDATE `C3SignUp` SET `Email`=?,`PhoneNumber`=?,`JobTitle`=?,`Institution`=? WHERE U_Id = ?";
    $stmt = $conn->prepare($sql);
    $result = $stmt->execute([$email, $phone, $title, $institution, $U_Id]);
        ...
        <form action="" method="POST">
          <div class="parent">
            <div class="div3">
              ...
              <input type="email" id="email" placeholder="Email" name="Email" value="<?php echo $email; ?>" readonly required>
            </div>
            <div class="div4">
              <label for="phoneNumber">Phone Number:</label>
              <input type="text" id="phoneNumber" placeholder="Phone Number" name="PhoneNumber" value="<?php echo $phone; ?>">
            </div>
            <div class="div5">
              <label for="jobTitle">Title:</label>
              <input type="text" id="jobTitle" placeholder="Title" name="JobTitle" value="<?php echo $title; ?>" required>
            </div>
            <div class="div6">
              <label for="institution">Institution:</label>
              <input type="text" id="institution" placeholder="Institution" name="Institution" value="<?php echo $institution; ?>"
                readonly required>
            </div>
            <div class="div7">
            ...
            <div class="div8">
              ...
              <input type="password" id="currentPassword" placeholder="Current Password" name="CurrentPassword" required autocomplete="email">
            </div>
            <div class="div9">
