    ...
    <div class="content-wrapper">
      <div class="content">
        <div class="scrollable-content">
          <h1>Record</h1>
          <p>Here, you can make a record of your data and optionally to upload for C3 contributors to access.  If you have DariyOne PDFs to upload, click DairyOne Data.  If you would like to make a record or upload other data, click C3 Research Data and fill out the record form.</p>
