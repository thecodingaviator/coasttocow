    ...
    <div class="content-wrapper">
      <div class="content">
        <div class="scrollable-content">
          <h1>Explore</h1>
          <p>Here, you can explore the data that has been uploaded to the C3 database.  If you would like to access available DairyOneData, click DairyOne Data. If you would like to access all other available data, click C3 Research Data.</p>
